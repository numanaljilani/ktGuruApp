    ...
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen
          ...
          name={navigationString.MANAGERESOURCES}
        />
        <Stack.Screen
          component={QuestionDetails}
          name={navigationString.QUESTION_DETAILS}
        />
        <Stack.Screen
          component={ProfileDetails}
          name={navigationString.PROFILEDETAILS}
        />
        <Stack.Screen
        ...
        />
        <Stack.Screen
          component={SubProjectBottomTabs}
          name={navigationString.SUBPROJECT}
        />
        <Stack.Screen
          component={SubQuestionDetails}
          name={navigationString.SUBPROJECT_QUESTION}
        />
        <Stack.Screen
          component={SingleChat}
          name={navigationString.SINGLE_CHAT}
        />
        <Stack.Screen
          component={SubSingleChat}
          name={navigationString.SUB_PRO_SINGLE_CHAT}
        />
        <Stack.Screen
          component={SubChatScreen}
          name={navigationString.SUB_PRO_CHAT}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
