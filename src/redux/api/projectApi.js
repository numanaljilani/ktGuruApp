...
export const {useGetallprojectMutation ,useDeleteprojectAPIMutation,useUpdateprojectAPIMutation
,useCreateprojectAPIMutation ,useTeamsMutation , useAddMutation,useActivityMutation,useNotificationMutation
} = project;
